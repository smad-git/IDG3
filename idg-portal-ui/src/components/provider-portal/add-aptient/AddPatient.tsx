...
import SearchBar, { SearchCriteria } from '../search-patient/SearchBar';
import PatientsCard from '../search-patient/PatientsCard';
...
export const AddPatient: React.FC<PropsWithChildren> = () => {
